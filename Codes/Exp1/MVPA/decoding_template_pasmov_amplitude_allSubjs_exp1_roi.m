% MVPA Passive Movement Exp 1 - amplitude - ROI
...
roi_filename = '5-sphere_5-63_-25_14_roi';
...
%     cfg.searchlight.radius = 3; % use searchlight of radius 3 (by default in voxels), see more details below
    ...
    if length(num2str(subj))==1
        ...
        cfg.results.dir = ['D:\MVPA_passive_movement\MVPA_results\Exp1\Amplitude\ROI_analysis_peaks_new\S0' num2str(subj) '\' roi_filename];
    else
        subj_folder=[folderName '\Data\S' num2str(subj)]; % subject folder
        cfg.results.dir = ['D:\MVPA_passive_movement\MVPA_results\Exp1\Amplitude\ROI_analysis_peaks_new\S' num2str(subj) '\' roi_filename];
    end

    beta_loc = [subj_folder '\1stLevel_unsmoothed'];

%     cfg.files.mask = ['D:\MVPA_passive_movement\Analysis\mask_lowerRes.nii'];
    cfg.files.mask = ['D:\MVPA_passive_movement\MVPA_results\Exp1\Amplitude\2ndLevel\peaks\'  roi_filename '.nii'];
